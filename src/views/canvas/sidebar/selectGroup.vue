...
const open = (id, Baddress, Eaddress) => {
  BTCaddress.value = Baddress;
  ETHaddress.value = Eaddress;
...
const doUseNft = async (addressB, addressE, id) => {
  try {
...
const confirm = () => {
  doUseNft(BTCaddress.value, ETHaddress.value, inscriptionID.value);
};
